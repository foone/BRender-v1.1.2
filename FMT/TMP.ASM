.386p
                ...
                EXTERNDEF   _fltused_ :BYTE
                EXTERNDEF   _BrFileClose :BYTE
                EXTERNDEF   _BrMaterialCount :BYTE
                EXTERNDEF   _BrMaterialEnum :BYTE
                EXTERNDEF   _BrFilePutLine :BYTE
                EXTERNDEF   _BrFileOpenWrite :BYTE
                EXTERNDEF   __DefaultScriptMaterial :BYTE
                EXTERNDEF   _BrFilePrintf :BYTE
